...
List<Breed> breedsFromJson(final List<dynamic> data) =>
    List<Breed>.from(data.map((final x) => Breed.fromJson(x)));

String breedToJson(final List<Breed> data) =>
    json.encode(List<dynamic>.from(data.map((final x) => x.toJson())));

class Breed extends ModelEntity {
  Breed({
  ...
  factory Breed.fromJson(final Map<String, dynamic> json) => Breed(
